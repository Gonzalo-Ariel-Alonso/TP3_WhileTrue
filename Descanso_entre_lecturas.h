...
{
private:
    Tipo_de_lectura lectura_actual;
    Tipo_de_lectura lectura_siguiente;
    int tiempo_de_descanso;
public:
    Descanso_entre_lecturas(Tipo_de_lectura lectura_actual, Tipo_de_lectura lectura_siguiente);
    ~Descanso_entre_lecturas();
    void set_tiempo_de_descanso();
    int get_tiempo_de_descanso();
};

Descanso_entre_lecturas::Descanso_entre_lecturas(Tipo_de_lectura lectura_actual,Tipo_de_lectura lectura_siguiente)
{
